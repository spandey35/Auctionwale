            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                ...
                {/* <a
                  ...
                  <button
  onClick={() => window.open("https://chat.whatsapp.com/Bh7uQqk4hEa4Q9kfspPP9O", "_blank")}
...
>
  Join Our WhatsApp Group
        ...
        <div className="relative z-20 transform overflow-hidden rounded-3xl bg-white  shadow-lg transition-transform duration-300  dark:bg-gray-800">
          <PropertySearch />
        </div>
      </section>
    </>
